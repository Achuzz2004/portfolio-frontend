              ...
              >
                ...
                <h2
                  className="text-2xl md:text-4xl font-bold bg-clip-text text-transparent 
                             bg-gradient-to-r from-pink-500 to-purple-500 break-words 
                ...
                {/* Headline */}
                <p className="mt-2 text-lg font-medium text-gray-600 dark:text-gray-300 text-center md:text-left">
                  {profile.headline}
                </p>

                {/* Bio */}
                <p className="mt-4 text-slate-700 dark:text-gray-300 break-words text-center md:text-left">
                  {profile.bio}
                </p>
                ...
                {/* Social Links */}
                <div className="flex gap-4 mt-4 text-2xl justify-center md:justify-start">
                  {profile.github && (
                    <a
                      href={profile.github}
                      target="_blank"
