...
export default function ProjectCard({ project }) {
  ...
  return (
    ...
    >
      {/* IMAGE */}
      <div className="relative h-44 sm:h-48 md:h-52 overflow-hidden group">
        <img
          src={project.image}
          alt={project.title}
      ...
      <div className="p-4 sm:p-5 flex flex-col flex-grow">
        ...
        <motion.p
          ...
          className="overflow-hidden text-sm sm:text-base 
                     text-gray-600 dark:text-gray-400 mt-2 leading-relaxed"
        >
          {project.description}
        </motion.p>
        ...
        {project.description?.length > 120 && (
          <button
            ...
            className="text-xs sm:text-sm text-pink-500 mt-1 self-start hover:underline"
          >
